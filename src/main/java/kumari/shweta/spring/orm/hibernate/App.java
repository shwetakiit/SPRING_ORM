...
public class App {
	public static void main(String[] args) {
		...
		/*
		 * //Save Employee obj in db Integer status=employeeDAO.insert(employeeDTO);
		...
		while (true) {
			...
			case 2:
				...
				System.out.println(employeeDTO2.getName() + " Id " + employeeDTO2.getEmployeeId() + " City :"
						+ employeeDTO2.getJobLocation());
				break;

			case 3:
				System.out.println("Fetch all employee records");
				...
				for (EmployeeDTO employee : list) {
					System.out.println("Id: " + employee.getEmployeeId() + " Name " + employee.getName()
							+ " Job Location :" + employee.getJobLocation());
				}
			...
			case 5:
				System.out.println("Update the employee record of employee ID???");
				Scanner sc2 = new Scanner(System.in);
				Integer employeeId = sc2.nextInt();
				Optional<EmployeeDTO> employee = Optional
						.ofNullable(employeeDAO.getHibernateTemplate().get(EmployeeDTO.class, employeeId));
